...
#     else:
#         current_vel.linear.x = round(linx, 2)
    
#     current_vel.angular.z = round(angz, 2)
...
def image_callback(msg):
    ...
    try:
        ...
        s='/home/hyun/catkin_ws/src/knu_prj/test_imgsss/camera_image'+str(count)+'.jpeg'
        # s='/home/iasl/catkin_ws/src/knu_prj/new_images_res/camera_image'+str(count)+'.jpeg'

        s2 = '/home/hyun/catkin_ws/src/knu_prj/new_label_res.txt'
