...
model = tf.keras.models.load_model("/home/iasl/catkin_ws/src/knu_prj/res_collision_model_new2/")
control_out = 0
...
def image_callback(image_data):
    ...
    a, b, c, d = -0.1, 0.5, 0.5, 0.5
    alpha = 0.8
    new_vel = (control_out[0] * a) + (control_out[1] * 0.1) + (control_out[2] * c) + (control_out[3] * 0.1) - collision_prob[0]
